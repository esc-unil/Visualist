...
from qgis.core import QgsVectorDataProvider, QgsCoordinateReferenceSystem, QgsProcessingUtils, QgsMessageLog
from qgis.gui import QgsMessageBar
from qgis.PyQt import QtCore, QtGui, QtWidgets, uic

from . import gdal_util
...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'ui_SpreadsheetLayersDialog.ui'))
...
class SpreadsheetLayersDialog(QtWidgets.QDialog, FORM_CLASS):
    ...
    def updateGeometry(self):
        if gdal_util.GDAL_COMPAT or self.offset() == 0:
    ...
    def gpkgPath(self):
        return u'{}.{}.gpkg'.format(self.filePath(), self.sheet())
